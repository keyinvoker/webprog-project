    ...
    <div class="card mb-4">
        <div class="d-flex flex-row">
            <div class="card-body d-flex flex-column justify-content-center">
                <form method="POST" action="{{url('admin/products/edit/'.Crypt::encrypt($product->id))}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror"  min="1" name="price" value="{{ round($product->price)}}" required autocomplete="price" autofocus>
                            </div>
